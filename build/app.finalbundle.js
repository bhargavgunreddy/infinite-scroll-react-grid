...
var EditableCell = React.createClass({
    ...
    handleEditCell: function handleEditCell(evt) {
    ...
    render: function render() {
        ...
        if (this.state.isEditMode) {
            cellHtml = React.createElement("input", { type: "text", value: this.state.data,
                onKeyDown: this.handleKeyDown, onChange: this.handleChange });
        } else {
            cellHtml = React.createElement("div", { onClick: this.handleEditCell }, this.state.data);
        }
        return React.createElement("td", null, cellHtml);
    }
});
...
var Movie = React.createClass({
    ...
    render: function render() {
        return React.createElement("tr", null, React.createElement(EditableCell, { data: this.props.title }), React.createElement(EditableCell, { data: this.props.rank }), React.createElement(EditableCell, { data: this.props.year }), React.createElement(EditableCell, { data: this.props.rating }), React.createElement(EditableCell, { data: this.props.reviews }));
    }
});
...
React.renderComponent(React.createElement("table", null, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", null, "Movie Title"), " ", React.createElement("th", null, "Rank"), React.createElement("th", null, "Year"), React.createElement("th", null, "Reviews"))), React.createElement(MovieList, { data: [{ "title": "Citizen Kane", "rank": "1", "year": "1941", "rating": "96%", "reviews": "155" }, { "title": "The Shawshank Redemption", "rank": "2", "year": "1995", "rating": "95%", "reviews": "145" }, { "title": "The Godfather", "rank": "3", "year": "1971", "rating": "94%", "reviews": "178" }] })), document.getElementById('grid'));
